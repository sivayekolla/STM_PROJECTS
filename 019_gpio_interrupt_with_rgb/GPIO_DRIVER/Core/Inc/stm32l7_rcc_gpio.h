...
typedef struct
{
    ...
    __vo uint32_t CFGR;          // 0x08 Clock register
    __vo uint32_t PLLCFGR;       // 0x0C PLL  register
    __vo uint32_t PLLSAI1CFGR;   // 0x10 PLL SAI1
    __vo uint32_t PLLSAI2CFGR;   // 0x14 PLL SAI2
    uint32_t RESERVED0;          
    __vo uint32_t CIER;          
    __vo uint32_t CIFR;          
    __vo uint32_t CICR;          
